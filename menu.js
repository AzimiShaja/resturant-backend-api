...
<div style="background-color: #f4f4f4; padding: 20px; border-radius: 5px;">
    ...
    <ul style="list-style-type: none; padding: 0;">
        <li style="margin-bottom: 30px;">
            <h3 style="color: #007bff;">Listing the Menu</h3>
            <strong style="color: #007bff;">METHOD:</strong> GET<br>
            <strong style="color: #007bff;">URL:</strong> http://localhost:3000/listMeals<br>
        ...
        <li style="margin-bottom: 30px;">
            <h3 style="color: #007bff;">Getting an Item from Menu</h3>
            <strong style="color: #007bff;">METHOD:</strong> GET<br>
            <strong style="color: #007bff;">URL:</strong> http://localhost:3000/getMeal<br>
            <strong style="color: #007bff;">QUERY PARAMS:</strong> ?id=1<br>
            <strong style="color: #007bff;">Request Body:</strong> None<br>
            <strong style="color: #007bff;">Response Body:</strong> Meal JSON
        </li>
        <li style="margin-bottom: 30px;">
            <h3 style="color: #007bff;">Quality Calculation With Ingredient Qualities</h3>
            <strong style="color: #007bff;">METHOD:</strong> POST<br>
            <strong style="color: #007bff;">URL:</strong> http://localhost:3000/quality<br>
        ...
        <li style="margin-bottom: 30px;">
            <h3 style="color: #007bff;">Price Calculation With Ingredient Qualities</h3>
            <strong style="color: #007bff;">METHOD:</strong> POST<br>
            <strong style="color: #007bff;">URL:</strong> http://localhost:3000/price<br>
            <strong style="color: #007bff;">BODY:</strong> { meal_id: 1, chicken: "high", rice: "medium", vegetables: "low" }<br>
            <strong style="color: #007bff;">Request Body:</strong> Ingredient Qualities JSON<br>
            <strong style="color: #007bff;">Response Body:</strong> Price JSON
        </li>
        <li style="margin-bottom: 30px;">
            <h3 style="color: #007bff;">I'm feeling lucky.</h3>
            <strong style="color: #007bff;">METHOD:</strong> POST<br>
        ...
        <li style="margin-bottom: 30px;">
            <h3 style="color: #007bff;">Searching For a Meal</h3>
            <strong style="color: #007bff;">METHOD:</strong> GET<br>
        ...
        <li>
            <h3 style="color: #007bff;">Finding the Highest Quality Meal For Given Budget</h3>
            <strong style="color: #007bff;">METHOD:</strong> POST<br>
